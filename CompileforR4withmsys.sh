...
alllibs="${osilibs} ${boostlibs} ${mingwlibs} ${moseklibs} C:/MrnMicro/Applic/R-testing/library/Rcpp/libs/x64/Rcpp.dll"
linkingflags="-L$pathtolib -L$pathtoRcpplib -L$pathtoboostlib -L$pathtomoseklib -lboost_system-mgw83-mt-x64-1_70 -lboost_serialization-mgw83-mt-x64-1_70 -lboost_iostreams-mgw83-mt-x64-1_70 -lR -lbz2 -lz -lfusion64_9_1 -lmosek64_9_1 -lcilkrts20 -lpthread -lmosekxx9_1 $alllibs -lgfortran -lquadmath"
object_files=""
for file in *.o; do
    if [[ -f "$file" ]]; then
