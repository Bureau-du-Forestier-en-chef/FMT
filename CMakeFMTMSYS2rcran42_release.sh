...
cmake CMakeLists.txt -B build/release -G "MSYS Makefiles" -DEXTRALINKERFLAGS="-lharfbuzz -lfreetype -lpoppler" -DPYTHON_DIR="C:/logiciels/Anaconda3/" -DCMAKE_BUILD_TYPE=Release -DPARALLEL_TESTS=8 -DOSI_DIR="D:/rtools42/home/Cbc-2.10.5/" -DBOOST_DIR="/x86_64-w64-mingw32.static.posix/" -DGDAL_DIR="/x86_64-w64-mingw32.static.posix/" -DR_DIR="C:/logiciels/R-4.2.1/" -DGEOS_DIR="/x86_64-w64-mingw32.static.posix/" -DGENERATE_RELEASE_PACKAGE=true
