    ...
    file(COPY "${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG.md" DESTINATION "${CMAKE_BINARY_DIR}/bin/${BUILD_TYPE}")
    file(COPY "${CMAKE_CURRENT_SOURCE_DIR}/CHANGELOG.fr.md" DESTINATION "${CMAKE_BINARY_DIR}/bin/${BUILD_TYPE}")
	...
	if (EXISTS "${CMAKE_BINARY_DIR}/bin/${BUILD_TYPE}/FMT")
		...
		file(COPY "${CMAKE_BINARY_DIR}/bin/${BUILD_TYPE}/LICENSES" DESTINATION "${CMAKE_BINARY_DIR}/bin/${BUILD_TYPE}/FMT/inst/libs/x64/")
		file(COPY "${CMAKE_BINARY_DIR}/bin/${BUILD_TYPE}/CHANGELOG.md" DESTINATION "${CMAKE_BINARY_DIR}/bin/${BUILD_TYPE}/FMT/inst/libs/x64/")
		file(COPY "${CMAKE_BINARY_DIR}/bin/${BUILD_TYPE}/CHANGELOG.fr.md" DESTINATION "${CMAKE_BINARY_DIR}/bin/${BUILD_TYPE}/FMT/inst/libs/x64/")
		if (GDAL_FOUND)
