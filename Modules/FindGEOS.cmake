...
if (WIN32)
	foreach(dllpath ${POTGEOS_DLL})
		if(("${dllpath}" MATCHES "Release") AND ("${BUILD_TYPE}" STREQUAL "Release"))
			list(APPEND GEOS_DLL "${dllpath}")
		elseif(("${dllpath}" MATCHES "Debug") AND ("${BUILD_TYPE}" STREQUAL "Debug"))
			list(APPEND GEOS_DLL "${dllpath}")
		endif()
	endforeach()
endif()
...
foreach(libpath ${POTGEOS_LIB})
		if(("${libpath}" MATCHES "Release"))
			list(APPEND GEOS_LIBRARIES "optimized")
			list(APPEND GEOS_LIBRARIES "${libpath}")
		elseif(("${libpath}" MATCHES "Debug"))
			list(APPEND GEOS_LIBRARIES "debug")
			list(APPEND GEOS_LIBRARIES "${libpath}")
		elseif(NOT MSVC)
			list(APPEND GEOS_LIBRARIES "${libpath}")
		elseif(MSVC AND "${libpath}" MATCHES "vcpkg")

			if("${libpath}" MATCHES "Debug")
				list(APPEND GEOS_LIBRARIES "debug")
				list(APPEND GEOS_LIBRARIES "${libpath}")
			else()
				list(APPEND GEOS_LIBRARIES "optimized")
				list(APPEND GEOS_LIBRARIES "${libpath}")
			endif("${libpath}" MATCHES "Debug")
