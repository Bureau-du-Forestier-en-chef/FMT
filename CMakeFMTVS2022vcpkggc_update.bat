...
cmake CMakeLists.txt -B build/release -G "Visual Studio 17 2022" -DBUILD_TYPE=Release -DPARALLEL_TESTS=8 -DGDAL_DIR="D:/dependencies/vcpkg/installed/x64-windows/" -DGEOS_DIR="D:/dependencies/vcpkg/installed/x64-windows/" -DONNXR_DIR="D:/dependencies/onnxruntime/" -DMOSEK_DIR="C:/PROGRA~1/Mosek/" -DOSI_DIR="D:/WindowsVS2017/Cbc-2.10.2/" -DBOOST_DIR="D:/dependencies/vcpkg/installed/x64-windows/" -DPYTHON_DIR="D:/dependencies/vcpkg/installed/x64-windows/tools/python3/"
