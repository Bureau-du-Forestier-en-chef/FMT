...
cmake CMakeLists.txt -B build/release -G "Eclipse CDT4 - Unix Makefiles" -DPARALLEL_TESTS=8 -DCMAKE_BUILD_TYPE=Release -DOSI_DIR="/home/forbr3/Cbc-2.9.8/" -DBOOST_DIR="/usr/" -DGDAL_DIR="/usr/" -DGEOS_DIR="/usr/" -DMOSEK_DIR="../../../../Mrnmicro/Applic/mosek/" -DPYTHON_DIR="/usr/" -DPYTHON_INCLUDE_DIR="/usr/include/python2.7/" -DPYTHON_LIBRARY="/usr/lib/libpython2.7.dll.a"
cmake --build build/release --config Release -j 8
cmake --install build/release --config Release
cmake CMakeLists.txt -B build/debug -G "Eclipse CDT4 - Unix Makefiles" -DPARALLEL_TESTS=8 -DCMAKE_BUILD_TYPE=Debug -DOSI_DIR="/home/forbr3/Cbc-2.9.8/" -DBOOST_DIR="/usr/" -DGDAL_DIR="/usr/" -DGEOS_DIR="/usr/" -DMOSEK_DIR="../../../../Mrnmicro/Applic/mosek/" -DPYTHON_DIR="/usr/" -DPYTHON_INCLUDE_DIR="/usr/include/python2.7/" -DPYTHON_LIBRARY="/usr/lib/libpython2.7.dll.a"
