...
namespace Models
{
	...
	*/
	...
	public:
		...
		/**
		 * @brief Aggregate actions together and return the new model by building a 
		 * @param ActionsMapping the old actions as keys and new actions as value.
		 * @return A new FMTmodel with aggregated actions.
		 */
		Models::FMTmodel aggregateActions(const std::map<std::string,std::string>& ActionsMapping) const;
