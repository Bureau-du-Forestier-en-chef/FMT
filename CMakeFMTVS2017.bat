...
cmake CMakeLists.txt -DCMAKE_BUILD_TYPE=Release ^
	...
	-DOSI_DIR="C:/MrnMicro/Applic/Cbc-2.10.2/" ^
	-DBOOST_DIR="C:/MrnMicro/Applic/boost_1_70_0/" ^
	-DGDAL_DIR="C:/MrnMicro/Applic/gdal-2.3.2/" ^
	-DGEOS_DIR="C:/MrnMicro/Applic/geos/" ^
	-DPYTHON_DIR="C:/MrnMicro/Applic/Anaconda3/" ^
