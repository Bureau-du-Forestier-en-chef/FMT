...
namespace Wrapper
{
	...
	public:
		...
		bool InitialAreaVariability(
			...
			int solver, 
			System::Collections::Generic::List<System::String^>^ contraintes, 
			int period, System::Collections::Generic::List<System::String^>^ outputs, 
			int outputLevel, 
			int etanduSortiesMin,
			int etanduSortiesMax, 
			System::String^ cheminSorties, 
	...
	private:
		...
		// M�thode helper pour envoyer les r�sultats via RetourJson
		void EnvoyerResultatsInterface(const FMTWrapperCore::SESResults& results, bool indCarbon);

		// ===================================================================
		// M�THODES SUPPRIM�ES - Logique d�plac�e dans SES.cpp
		// ===================================================================
		// Les m�thodes suivantes ont �t� supprim�es car leur logique
		...
		//
		// Toute la logique est maintenant orchestr�e par SES::RunSES()
		// ===================================================================
	};
}
#endif