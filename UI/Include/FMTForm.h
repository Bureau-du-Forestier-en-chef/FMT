...
namespace Wrapper
{
	...
	public:
		...
		/**
		* @brief Agr�ge toutes les actions en utilisant le mod�le sp�cifi�.
		*
		* Cette fonction agr�ge toutes les actions bas�es sur l'index du mod�le et les param�tres fournis.
		*
		* @param p_modelIndex Index du mod�le � utiliser pour l'agr�gation.
		* @param p_aggregates Liste des actions agr�g�es.
		* @param p_schedulePri Le path du fichier .pri.
		* @param p_outputDirPath Le path du dossier de sortie.
		* @param p_scenario_name Nom du sc�nario.
		* @return `true` si l'agr�gation a r�ussi, `false` sinon.
		*/
		...
		/**
		* @brief S�pare les actions en utilisant le mod�le sp�cifi�.
		*
		* Cette fonction divise les actions bas�es sur l'index du mod�le et les param�tres fournis.
		*
		* @param p_modelIndex Index du mod�le � utiliser pour la s�paration.
		* @param p_schedulePri Le path du fichier .pri.
		* @param p_splitted Liste sur lequel les splits sont effectu� ex: {"ACT","AEC"}.
		* @param p_splitted_mask Le mask a splitter.
		* @param p_outputDirPath Le path du dossier sortie.
		* @param p_scenario_name Nom du sc�nario.
		* @return `true` si la s�paration a r�ussi, `false` sinon.
		*/
		...
		*@param p_schedulePri Le path du fichier .pri
		*@param p_outputDirPath Le path du dossier de sortie
		*@param p_scenario_name Le nom du sc�nario
		*@return vrai ou faux
		*/
		...
		/**
		* @brief Donne tous les attriduts du mod�le selon le th�me.
		*
		*@param p_modelIndex Index du mod�le � utiliser.
		*@param p_themeIndex Index du th�me souhait� dans la liste des th�me du mod�le.
		*@return Retourne une liste d'attributs du th�me.
		*/
		...
		*
		*@param p_modelIndex Index du mod�le � utiliser.
		*@param p_mask Le mask � valider.
		*@return Retourne true ou false.
		*/
		bool validateMask(const int p_modelIndex, System::String^ p_mask);

		/**
		* @brief Retourne tous les masks du mod�le utilis� selon les th�mes.
		*
		*@param p_modelIndex Index du mod�le � utiliser.
		*@param p_themes Liste des th�mes � v�rifier.
