...
cmake CMakeLists.txt -B build/debug -G "Visual Studio 15 2017 Win64" -DBUILD_TYPE=Debug -DPARALLEL_TESTS=2 -DONNXR_DIR=C:/MrnMicro/Applic/onnxruntime -DMOSEK_DIR="C:/PROGRA~1/Mosek/" -DOSI_DIR="C:/MrnMicro/Applic/Cbc-2.10.2/" -DBOOST_DIR="C:/MrnMicro/Applic/boost_1_71_0_shared/" -DGDAL_DIR="C:/MrnMicro/Applic/gdal-2.3.2/" -DGEOS_DIR="C:/MrnMicro/Applic/geos/" -DPYTHON_DIR="C:/MrnMicro/Applic/Anaconda3/"
cmake --build build/debug --config Debug -j 8
cmake --install build/debug --config Debug
cmake CMakeLists.txt -B build/release -G "Visual Studio 15 2017 Win64" -DBUILD_TYPE=Release -DPARALLEL_TESTS=2 -DMOSEK_DIR="C:/PROGRA~1/Mosek/" -DOSI_DIR="C:/MrnMicro/Applic/Cbc-2.10.2/" -DBOOST_DIR="C:/MrnMicro/Applic/boost_1_71_0_shared/" -DGDAL_DIR="C:/MrnMicro/Applic/gdal-2.3.2/" -DGEOS_DIR="C:/MrnMicro/Applic/geos/" -DPYTHON_DIR="C:/MrnMicro/Applic/Anaconda3/"
