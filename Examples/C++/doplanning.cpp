...
int main(int argc, char* argv[])
{
	...
	if (Version::FMTversion().hasfeature("OSI"))
	{
		...
		/*const std::string primarylocation = "T:/Donnees/02_Courant/07_Outil_moyen_methode/01_Entretien_developpement/Interne/FMT/Entretien/Modeles_test/actionseries/PC_9509_U02751_4_Vg2_2023_vRp2.pri";
		const std::string scenario = "14_sc5_determin_apsp_ref_aam_ratioplct_action_series_3";
		const int length = 5;
		const double objectivevalue = 2523996;*/
