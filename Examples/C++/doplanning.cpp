...
int main(int argc, char* argv[])
{
	...
	if (Version::FMTversion().hasfeature("OSI"))
	{
		...
		const std::string primarylocation =  "D:/BT2022090613_COS_bfecoptFMT_PC9348_U02666/PC_9348_U02666_4_Vg2_2023_vRP1f.pri";//results.at(0);
		const std::string scenario = "13_Sc5a_Determin_avsp_BFECopt";//results.at(1);
		const int length = 30;//std::stoi(argv[2]);
		const double objectivevalue = 1.81650038e+06;//std::stod(argv[3]);
