...
int main(int argc, char* argv[])
{
	...
	if (Version::FMTversion().hasfeature("OSI"))
	{
		...
		const std::string primarylocation = "D:/dump_test/BT2022090613_COS_bfecoptFMT_PC9348_U02666/PC_9348_U02666_4_Vg2_2023_vRP1f.pri";// results.at(0);
		...
		std::shared_ptr<Exception::FMTexceptionhandler>& exhandler(new Exception::FMTdefaultexceptionhandler());
		exhandler->setmaxwarningsbeforesilenced(1000);
		Parser::FMTmodelparser modelparser;
		modelparser.passinexceptionhandler()
		...
		modelparser.write(optimizationmodel, "D:/dump_test/BT2022090613_COS_bfecoptFMT_PC9348_U02666/FMTmodel/");
		if (optimizationmodel.doplanning(true)) {
			std::cout << std::to_string(optimizationmodel.getObjValue()) << std::endl;
		}
		//optimizationmodel.writeLP("D:/dump_test/BT2022090613_COS_bfecoptFMT_PC9348_U02666/FMTmodel/");
