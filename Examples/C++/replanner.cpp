...
int main(int argc, char *argv[])
	...
	{
		primlocation = "C:\\Users\\Admlocal\\Documents\\issues\\C2_01004929\\CC_modele_feu\\WS_CC\\Feux_2023_ouest_V01.pri";
	...
	std::vector<std::string> OutputtoLookFor = { 
		...
		"ORISQUE_TBE_NOR","ORISQUE_NOR","OVOLGFIREC","OVOLGFTREC","OVOLGRREC", "SS_10","SS_25","SS_50","SS_100","SS_200",
		"SS_400","SR_10","SR_25","SR_50","SR_100","SR_200","SR_400","REST_10","REST_25","REST_50","REST_100","REST_200","REST_400",
		"ORISQUEYVS", "OVOLTOTREC","OVOLGSEPMREC","OVOLTOTREC_RECUP","OVOLTOTRECARECUP","OSUPREALREGAREG","OSUPREALPL_BR",
		"OSUPREALREGAREG_TOT","OSUPREALREGAEDU_TOT","OSUPREALREGAEDU","OSUPREALREGAEDU_BR","OSUPREALREGAPAR_TOT","OSUPREALREGAPAR",
		"OSUPREALREGAPAR_BR","OSUPBRULER_ORI","OSUPBRULER_CORRIGER","MORT_ADM","OSUPMORTFEUX","OSUPTBE","OTBECOMP","OCATTBE_SS",
		"OCATTBE_SR","OCATTBE_SF","OCATTBE_FRS","OCATTBE_PE","OCATTBE_AU","SUPERFICIE_RECUP_FEU","SUPERFICIE_ADM_RECUP_FEU",
		"OSUPPLPIG_FEU23_UA_POSTRECUP","OSUPPLEP_FEU23_UA_POSTRECUP","OSUPPL_FEU_POSTRECUP","OSUPPLPIG_FEU23_UA_POSTRECUP_ADM",
		"OSUPPLEP_FEU23_UA_POSTRECUP_ADM","OSUPPL_FEU_POSTRECUP_ADM","SUP_ADM_ACPPTM_BR","OSUPADM_RECUP_FEU_M3HA_SEPM_70_99",
