...
int main(int argc, char *argv[])
	...
	std::vector<std::string> OutputtoLookFor = { "OVOLTOTREC" ,/*"OSUPTOT",*/"OVOL_UA_TOTREC" ,"OSUPBRULER_CORRIGER" ,
		"SUPERFICIE_RECUP_FEU",/*"OSUPPL_FEU_POSTRECUP",*/ "OSUPTBE", "SUPERFICIE_RECUP_TBE",
		/*"OCATTBE_C1" ,"OCATTBE_C2" ,"OCATTBE_C3", "OCATTBE_C4","OCATTBE_C5","OCATTBE_C6","OTBECOMP","OSUPADMATBE"*/};
