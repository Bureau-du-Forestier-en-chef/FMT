...
int main(int argc, char* argv[])
{
	...
	if (Version::FMTversion().hasfeature("OSI"))
	{
		...
		/*const std::string primarylocation = "T:/Donnees/02_Courant/07_Outil_moyen_methode/01_Entretien_developpement/09_FMT/Modeles_test/COS_03771/PC_9310_U03771_4_Vg3_2023_vSSP03.pri";
		const std::string scenario = "13_Sc5a_Determin_avsp";
		const int length = 10;
