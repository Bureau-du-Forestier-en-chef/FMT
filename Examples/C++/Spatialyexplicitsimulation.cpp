...
int main()
{
	...
	const std::string modellocation = "D:/dump_test/02651/";
	const std::string	primarylocation = modellocation + "PC_9301_U02651_4_Vg2_2023_vRP1f.pri";
	const std::string outdir = "D:/dump_test/02651/out";
