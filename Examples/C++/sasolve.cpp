...
int main(int argc, char* argv[])
{
	...
	if (Version::FMTversion().hasfeature("GDAL"))
	{
		...
		optimizationmodel.setparameter(Models::FMTintmodelparameters::MAX_ACCEPTED_CYCLE_MOVES, 1000);
		optimizationmodel.setparameter(Models::FMTintmodelparameters::MAX_CYCLE_MOVES, 4000);
